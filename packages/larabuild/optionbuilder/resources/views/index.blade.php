...
@push(config('optionbuilder.style_var'))
    ...
    <link rel="stylesheet" href="{{ asset('vendor/optionbuilder/css/main.css') }}">
@endpush
            ...
            if( form_id !='' ){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(!$('#social_login-tab').hasClass('active') && !$('#smtp_setting').hasClass('active') && !$('#_storage').hasClass('active') && !$('#_theme').hasClass('active') && data.success  ){
