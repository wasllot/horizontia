...
<div class="master">
    <div class="box">
        <div class="header">
            <img src="{{ asset('demo-content/logo-white.svg') }}" height="40px" alt="">
        ...
        <ul class="step">
            ...
            <li class="step__divider"></li>
            <li class="step__item {{ isActive('LaravelInstaller::database') }} {{ isActive('LaravelInstaller::import') }}"><i class="step__icon ion-android-download"></i></li>
            <li class="step__divider"></li>
