...
namespace Modules\MeetFusion\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;
use Modules\MeetFusion\Factories\MeetFusionFactory;
...
class MeetFusionServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'MeetFusion';

    protected string $nameLower = 'meetfusion';
