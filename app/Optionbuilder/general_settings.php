...
return [
    ...
    'fields' => [
        ...
        [
            ...
            'type'          => 'switch',
            'tab_id'        => 'security_tab',
            'tab_title'     => 'Seguridad (reCAPTCHA)',
            'class'         => '',
            'label_title'   => 'Habilitar reCAPTCHA v2',
            'field_desc'    => 'Activar para proteger los formularios públicos (Contacto, Registro, etc.) de spam y bots.',
            'value'         => '0',
        ],
        [
            ...
            'value'         => '',
            'class'         => '',
            'label_title'   => 'Clave del Sitio (Site Key)',
            'placeholder'   => 'Ingresa la clave del sitio de Google reCAPTCHA v2',
        ],
        [
            ...
            'value'         => '',
            'class'         => '',
            'label_title'   => 'Clave Secreta (Secret Key)',
            'placeholder'   => 'Ingresa la clave secreta de Google reCAPTCHA v2',
        ],
    ]
];
