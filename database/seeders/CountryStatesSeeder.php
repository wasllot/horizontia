...
class CountryStatesSeeder extends Seeder {
    ...
    public function run() {
        ...
        $states = array(
            ...
            '11' => array( // Argentinian provinces.
            ...
            '19' => array( // Bangladeshi states (districts).
                'BD-05' => 'Bagerhat',
                'BD-01' => 'Bandarban',
                'BD-02' => 'Barguna',
                'BD-06' => 'Barishal',
            ...
            '216' => array( // Cantons of Switzerland.
                'AG' => 'Aargau',
            ...
            '100' => array( // Hong Kong states.
                'HONG KONG'       => 'Hong Kong Island',
                'KOWLOON'         => 'Kowloon',
                'NEW TERRITORIES' => 'New Territories',
            ),
            '101' => array( // Hungary states.
                'BK' => 'Bács-Kiskun',
                'BE' => 'Békés',
                'BA' => 'Baranya',
            ...
            '111' => array( // Jamaica's Parishes. Ref: https://en.wikipedia.org/wiki/ISO_3166-2:JM.
                'JM-01' => 'Kingston',
                'JM-02' => 'Saint Andrew',
                'JM-03' => 'Saint Thomas',
                'JM-04' => 'Portland',
            ...
            '152' => array( // Mozambique provinces.
                'MZP'   => 'Cabo Delgado',
                'MZG'   => 'Gaza',
                'MZI'   => 'Inhambane',
                'MZB'   => 'Manica',
            ...
            '197' => array( // Serbia districts. Ref: https://github.com/unicode-org/cldr/blob/release-37/common/subdivisions/en.xml#L4251-L4283.
                'RS00' => 'Belgrade',
                'RS14' => 'Bor',
                'RS11' => 'Braničevo',
                'RS02' => 'Central Banat',
            ...
            '232' => array( // Uganda districts. Ref: https://en.wikipedia.org/wiki/ISO_3166-2:UG.
                'UG314' => 'Abim',
                'UG301' => 'Adjumani',
                'UG322' => 'Agago',
                'UG323' => 'Alebtong',
            ...
            '241' => array( // Venezuela States. Ref: https://github.com/unicode-org/cldr/blob/release-38-1/common/subdivisions/en.xml#L5426-L5451
                'A' => 'Capital',
                'B' => 'Anzoátegui',
                'C' => 'Apure',
                'D' => 'Aragua',
                ...
                'U' => 'Yaracuy',
                'V' => 'Zulia',
                'W' => 'Federal Dependencies',
                'X' => 'Vargas',
                'Y' => 'Delta Amacuro',
                'Z' => 'Amazonas'
            ),
            '206' => array( // South African states.
                'EC'  => 'Eastern Cape',
                'FS'  => 'Free State',
                'GP'  => 'Gauteng',
                'KZN' => 'KwaZulu-Natal',
            ...
            '248' => array( // Zambia's Provinces. Ref: https://en.wikipedia.org/wiki/ISO_3166-2:ZM.
                'ZM-01' => 'Western',
                'ZM-02' => 'Central',
                'ZM-03' => 'Eastern',
                'ZM-04' => 'Luapula',
        ...
        foreach ($states as $country_id => $states) {
            $is_district    = $country_id == '197' ? 1 : 0;
            $state_list     = [];
            foreach ($states as $short_code => $state_name) {
                $state_list[] = [
            ...
            CountryState::insert($state_list);
        }
    }
}
